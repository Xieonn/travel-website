...
<style>
    ...
    .pd-breadcrumb a:hover { color: var(--pd-blue); }
    .pd-breadcrumb span { color: var(--pd-ink); font-weight: 500; }
    ...
    /* Info Panel */
    .pd-info-panel { display: flex; flex-direction: column; gap: 1.25rem; }
    ...
    .pd-stars .star.filled { color: var(--pd-gold); }
    .pd-stars .star.half { color: var(--pd-gold); }
    .pd-avg-num {
        font-size: 1rem;
        font-weight: 700;
        color: var(--pd-ink);
    ...
    .pd-meta-label { color: var(--pd-muted); min-width: 60px; }
    .pd-meta-value { font-weight: 500; color: var(--pd-ink); }
    ...
    .stock-green { color: var(--pd-green); }
    .stock-red { color: var(--pd-red); }
    .stock-red .pd-stock-dot { background: var(--pd-red); }

    .pd-seller {
        font-size: 0.82rem;
        color: var(--pd-muted);
    }
    .pd-seller strong { color: var(--pd-ink); }
    ...
    .pd-tab-btn:hover { color: var(--pd-ink); }
    ...
    .pd-specs-table tr { border-bottom: 1px solid var(--pd-border); }
    .pd-specs-table td {
        padding: 10px 0;
        color: var(--pd-muted);
    }
    ...
    .pd-big-rating .stars-row span { color: var(--pd-gold); font-size: 1.1rem; }
    .pd-big-rating .lbl { font-size: 0.8rem; color: var(--pd-muted); }
    ...
    .pd-rating-bar-row .lbl { color: var(--pd-muted); width: 50px; text-align: right; }
    .pd-bar-track {
        flex: 1;
        height: 8px;
    ...
    .pd-rating-bar-row .cnt { width: 20px; color: var(--pd-muted); font-weight: 600; font-size: 0.75rem; }
    ...
    .star-picker input:checked ~ label { color: #ddd; }
    .star-picker input:checked + label,
    .star-picker label:hover { color: var(--pd-gold); }

    /* JS-controlled star picker */
    .star-picker .s-label.active { color: var(--pd-gold); }
    ...
    .pd-review-form-card textarea:focus { border-color: var(--pd-blue); }
    ...
    .pd-btn-submit-review:hover { background: #145088; }
    ...
    .pd-login-prompt a { color: var(--pd-blue); font-weight: 600; text-decoration: none; }
    ...
    .pd-reviewer-info strong { display: block; font-size: 0.9rem; color: var(--pd-ink); }
    .pd-reviewer-date { font-size: 0.78rem; color: var(--pd-muted); }
    .pd-review-stars { margin-left: auto; display: flex; gap: 2px; }
    .pd-review-stars span { color: var(--pd-gold); font-size: 0.9rem; }
    .pd-review-comment { font-size: 0.875rem; color: #444; line-height: 1.65; }
    .pd-own-badge {
        font-size: 0.72rem;
        color: var(--pd-blue);
        background: #e8f4fd;
    ...
    .pd-delete-review:hover { background: rgba(239,68,68,0.06); }
    ...
    .pd-flash-success { background: rgba(16,185,129,0.08); border: 1px solid rgba(16,185,129,0.25); color: #065F46; }

    @media (max-width: 768px) {
        .pd-top { grid-template-columns: 1fr; gap: 1.5rem; }
        .pd-name { font-size: 1.4rem; }
        .pd-price { font-size: 1.5rem; }
        .pd-review-summary { flex-direction: column; gap: 1.5rem; }
